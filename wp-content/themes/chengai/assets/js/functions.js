	...
	SEMICOLON.widget = {
		...
		extras: function(){
			...
			$('#primary-menu-trigger,#overlay-menu-close').off('click').on( 'click', function() {
				...
				$( '#header .header-bottom-info').toggleClass('d-menu');
				$( '#primary-menu-trigger .icon-reorder').toggleClass('d-icon');
				$( '.login-jp-block').toggleClass('d-menu');
				$( '.nav-item').toggleClass('d-login');
				$( '#logo img').toggleClass('d-logo');
				$( '.nav-translation').toggleClass('d-nav-transition');
