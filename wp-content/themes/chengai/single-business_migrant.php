					...
					<div class="post-navigation clearfix">
						...
						<?php 
								the_post_navigation( array(
									'prev_text' => '<div class="col_half nobottommargin">' . __( 'Previous Post', 'twentyseventeen' ) . '<span class="nav-title"><span class="nav-title-icon-wrapper">' . twentyseventeen_get_svg( array( 'icon' => 'arrow-left' ) ) . '</span>%title</span></div> ',
