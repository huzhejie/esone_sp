<?php
/*
 * Template Name: project_investment
 * 作者：WordPress花园
 *
 **/
get_header();
...
<section id="content">
  ...
  <div class="content-main">
    <div class="project-investment-block">
      <div class="project-investment-content">
      <div class="container">
          <div class="project-investment-info">
          <?php 
            $postArray = array(
          ...
          ?>
                      ...
                      <div class="project-investment-dec investmentl-dec-left">
                      <a href="<?php the_permalink();?>">
              <div class="row">
                <div class="col-12 col-md-7 content-dec-img">
                  <div class="project-investment-img">
                    <img src="<?php $img_data = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'full'); echo $img_data[0]?>" alt="project-investment-img">
                  </div>
                </div>
                <div class="col-12 col-md-5 content-dec-block">
                  <div class="content-dec-text">
                    <div class="project-investment-title">
                      <h3><?php the_title(); ?></h3>
                    </div>
                    <div class="project-investment-text">
                    <?php the_excerpt() ?>
                    </div>
          ...
          <?php 
              ...
              ?>
                          ...
                          <div class="project-investment-dec investmentl-dec-right">
                          <a href="<?php the_permalink();?>">
              <div class="row">
                <div class="col-12 col-md-7 content-dec-img">
                    <div class="project-investment-img">
