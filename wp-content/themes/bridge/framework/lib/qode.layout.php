...
class QodeFieldYesNo extends QodeFieldType {
	...
	public function render( $name, $label="", $description="", $options = array(), $args = array(), $hidden = false, $repeat = array() ) {
		...
		<div class="qodef-page-form-section" id="qodef_<?php echo $id; ?>">
						...
						<div class="col-lg-12">
							...
							<div class="qodef-gallery-uploader">
								...
								<a class="qodef-gallery-clear-btn btn btn-sm btn-default pull-right"
								   href="javascript:void(0)"><?php _e('删除所有'); ?></a>
							</div>
						</div>
					</div>
				</div>
...
class QodeImagesVideosFramework implements iRender {
	...
	public function render($factory) {
		...
		<div class="qodef-hidden-portfolio-images"  style="display: none">
			<div class="qodef-portfolio-toggle-holder">
				<div class="qodef-portfolio-toggle qodef-toggle-desc">
					<span class="number">1</span><span class="qodef-toggle-inner">图片 - （序号，图片标题）</span>
				</div>
					...
					<div class="qodef-section-content">
						<div class="container-fluid">
							<div class="row">
								<div class="col-lg-2">
									<div class="qodef-media-uploader">
										<em class="qodef-field-description">图片</em>
										...
										<a class="qodef-media-upload-btn btn btn-sm btn-primary" href="javascript:void(0)" data-frame-title="选择图片" data-frame-button-text="选择图片">上传</a>
										<a style="display: none;" href="javascript: void(0)" class="qodef-media-remove-btn btn btn-default btn-sm">删除</a>
									</div>
								</div>
								<div class="col-lg-2">
									<em class="qodef-field-description">序号</em>
								...
								<div class="col-lg-8">
									<em class="qodef-field-description">图片标题（仅在选择相册作品类型时工作）</em>
		...
		<div class="qodef-hidden-portfolio-videos"  style="display: none">
			<div class="qodef-portfolio-toggle-holder">
				<div class="qodef-portfolio-toggle qodef-toggle-desc">
					<span class="number">2</span><span class="qodef-toggle-inner">视频 - （序号、视频标题）</span>
				</div>
				<div class="qodef-portfolio-toggle qodef-portfolio-control">
					...
					<div class="qodef-section-content">
						<div class="container-fluid">
							<div class="row">
								<div class="col-lg-2">
									<div class="qodef-media-uploader">
										<em class="qodef-field-description">封面视频图片</em>
										<div style="display: none" class="qodef-media-image-holder">
											<img src="" alt="" class="qodef-media-image img-thumbnail">
										</div>
								...
								<div class="col-lg-10">
									<div class="row">
										...
										<div class="col-lg-10">
											<em class="qodef-field-description">视频标题（仅当选择相册作品类型时工作）</em>
											<input type="text" class="form-control qodef-input qodef-form-element" id="portfoliotitle_x" name="portfoliotitle_x" placeholder="">
										</div>
									</div>
									<div class="row next-row">
										<div class="col-lg-2">
											<em class="qodef-field-description">视频类型</em>
											<select class="form-control qodef-form-element qodef-portfoliovideotype" name="portfoliovideotype_x" id="portfoliovideotype_x">
												<option value=""></option>
												<option value="youtube">Youtube</option>
												<option value="vimeo">Vimeo</option>
												<option value="self">自托管</option>
											</select>
										</div>
										<div class="col-lg-2 qodef-video-id-holder">
											<em class="qodef-field-description" id="videoId">视频ID</em>
									...
									<div class="row next-row qodef-video-self-hosted-path-holder">
										<div class="col-lg-4">
											<em class="qodef-field-description">视频webm</em>
										...
										<div class="col-lg-4">
											<em class="qodef-field-description">视频mp4</em>
										...
										<div class="col-lg-4">
											<em class="qodef-field-description">视频ogv</em>
		...
		while (isset($portfolio_images[$no-1])) {
			...
			if ($portfolio_img_type == "image") {
				...
				<div class="qodef-portfolio-images qodef-portfolio-media" rel="<?php echo $no; ?>">
					<div class="qodef-portfolio-toggle-holder">
						<div class="qodef-portfolio-toggle qodef-toggle-desc">
							<span class="number"><?php echo $no; ?></span><span class="qodef-toggle-inner">图片 - (<?php echo stripslashes($portfolio_image['portfolioimgordernumber']); ?>, <?php echo stripslashes($portfolio_image['portfoliotitle']); ?>)</span>
						</div>
						<div class="qodef-portfolio-toggle qodef-portfolio-control">
							...
							<div class="qodef-section-content">
								<div class="container-fluid">
									<div class="row">
										...
										<div class="col-lg-8">
											<em class="qodef-field-description">图片标题（仅当选择相册作品类型时工作） </em>
			...
			<?php
				...
				<div class="qodef-portfolio-videos qodef-portfolio-media" rel="<?php echo $no; ?>">
					<div class="qodef-portfolio-toggle-holder">
						<div class="qodef-portfolio-toggle qodef-toggle-desc">
							<span class="number"><?php echo $no; ?></span><span class="qodef-toggle-inner">视频 - <em>(<?php echo stripslashes($portfolio_image['portfolioimgordernumber']); ?>, <?php echo stripslashes($portfolio_image['portfoliotitle']); ?></em>) </span>
						</div>
						<div class="qodef-portfolio-toggle qodef-portfolio-control">
									...
									<div class="row">
										...
										<div class="col-lg-10">
											...
											<div class="row next-row">
												...
												<div class="col-lg-2 qodef-video-id-holder">
													<em class="qodef-field-description">视频 ID</em>
													<input type="text"
														   class="form-control qodef-input qodef-form-element"
														   id="portfoliovideoid_<?php echo $no; ?>"
														   name="portfoliovideoid[]" value="<?php echo isset($portfolio_image['portfoliovideoid'])?stripslashes($portfolio_image['portfoliovideoid']):""; ?>"
											...
											<div class="row next-row qodef-video-self-hosted-path-holder">
												<div class="col-lg-4">
													<em class="qodef-field-description">视频 webm</em>
													<input type="text"
														   class="form-control qodef-input qodef-form-element"
														   id="portfoliovideowebm_<?php echo $no; ?>"
														   name="portfoliovideowebm[]" value="<?php echo isset($portfolio_image['portfoliovideowebm'])?stripslashes($portfolio_image['portfoliovideowebm']):""; ?>"
														   placeholder=""/></div>
												<div class="col-lg-4">
													<em class="qodef-field-description">视频 mp4</em>
													<input type="text"
														   class="form-control qodef-input qodef-form-element"
														   id="portfoliovideomp4_<?php echo $no; ?>"
														   name="portfoliovideomp4[]" value="<?php echo isset($portfolio_image['portfoliovideomp4'])?stripslashes($portfolio_image['portfoliovideomp4']):""; ?>"
														   placeholder=""/></div>
												<div class="col-lg-4">
													<em class="qodef-field-description">视频 ogv</em>
													<input type="text"
														   class="form-control qodef-input qodef-form-element"
														   id="portfoliovideoogv_<?php echo $no; ?>"
														   name="portfoliovideoogv[]" value="<?php echo isset($portfolio_image['portfoliovideoogv'])?stripslashes($portfolio_image['portfoliovideoogv']):""; ?>"
		...
		<div class="qodef-portfolio-add">
			<a class="qodef-add-image btn btn-sm btn-primary" href="#"><i class="fa fa-camera"></i>添加图片</a>
			<a class="qodef-add-video btn btn-sm btn-primary" href="#"><i class="fa fa-video-camera"></i>添加视频</a>

			<a class="qodef-toggle-all-media btn btn-sm btn-default pull-right" href="#"> 展开全部</a>
...
class QodeRepeater implements iRender
{
	...
	function __construct($fields, $name, $label = '', $description = '', $button_text = '')
	{
		...
		$this->name = $name;
		$this->num_of_rows = 1;
		$this->button_text = !empty($button_text) ? $button_text : '添加新项目';
			...
			<?php if (! empty($clones) && count($clones) > 0) {
				...
				<div class="qodef-repeater-fields-holder qodef-sort-parent clearfix" data-index="<?php echo esc_attr($counter); ?>">
					...
					<div class="qodef-repeater-fields">
						<?php
							foreach ($this->fields as $field) { ?>
								<div class="qodef-repeater-field-row">
	...
	public function render($factory) {
		...
		if(!empty($_GET['oauth_token']) && !empty($_GET['oauth_verifier'])) {
			...
			if($responseObj->status) {
				$message = esc_html__('您已成功与你的Twitter帐户连接。如果你从Twitter获取数据有任何问题，尝试重新连接。', 'qode');
			} else {
				$message = $responseObj->message;
			}
		}

		$buttonText = $twitterApi->hasUserConnected() ? esc_html__('重新连接Twitter', 'bridge') : esc_html__('连接Twitter', 'qode');
		?>
		<?php if($message !== '') { ?>
		...
		<div class="qodef-page-form-section" id="qodef_enable_social_share_twitter">
			...
			<div class="qodef-field-desc">
				<h4><?php esc_html_e('连接Twitter', 'qode'); ?></h4>

				<p><?php esc_html_e('连接Twitter将启用在网站显示最新推文', 'qode'); ?></p>
			</div>
			<!-- close div.qodef-field-desc -->
...
class QodeOptionsFramework implements iRender {
	...
	public function render($factory) {
		...
		<div class="qodef-portfolio-additional-item-holder" style="display: none">
			<div class="qodef-portfolio-toggle-holder">
				<div class="qodef-portfolio-toggle qodef-toggle-desc">
					<span class="number">1</span><span class="qodef-toggle-inner">附加侧边栏项目 (序号、项目标题)</span>
				</div>
				<div class="qodef-portfolio-toggle qodef-portfolio-control">
		...
		while (isset($portfolios[$no-1])) {
			...
			<div class="qodef-portfolio-additional-item" rel="<?php echo $no; ?>">
				<div class="qodef-portfolio-toggle-holder">
					<div class="qodef-portfolio-toggle qodef-toggle-desc">
						<span class="number"><?php echo $no; ?></span><span class="qodef-toggle-inner">附加侧边栏项目 - (<?php echo stripslashes($portfolio['optionlabelordernumber']); ?>, <?php echo stripslashes($portfolio['optionLabel']); ?>)</span>
					</div>
					<div class="qodef-portfolio-toggle qodef-portfolio-control">
		...
		<div class="qodef-portfolio-add">
			<a class="qodef-add-item btn btn-sm btn-primary" href="#">添加项目</a>


			<a class="qodef-toggle-all-item btn btn-sm btn-default pull-right" href="#">展开所有</a>
						...
						<div class="qodef-page-form-section" >
							<div class="qodef-section-content">
								<div class="container-fluid">
									<div class="row">
										<div class="col-lg-12">
											<button type="button" class="btn btn-primary btn-sm " name="import" id="qodef-import-theme-options-btn" data-waiting-message="<?php esc_html_e('Please wait', 'qode'); ?>" data-confirm-message="<?php esc_html_e('Are you sure, you want to import Options now?', 'qode'); ?>">导入</button>
