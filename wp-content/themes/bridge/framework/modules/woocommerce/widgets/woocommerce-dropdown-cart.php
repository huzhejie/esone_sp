	...
	public function widget( $args, $instance ) {
		...
		<div class="shopping_cart_header">
			...
			<?php endif; ?>
                ...
                <a itemprop="url" href="<?php echo wc_get_cart_url(); ?>" class="qbutton white view-cart"><?php _e( 'Cart', 'woocommerce' ); ?> <i class="fa fa-shopping-cart"></i></a>
