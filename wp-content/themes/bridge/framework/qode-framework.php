...
function qode_theme_menu() {
	...
	init_qode_theme_options();
      ...
      '主题选项',                   // The value used to populate the browser's title bar when the menu page is active
      '主题选项',                   // The text of the menu in the administrator's sidebar
	...
	foreach ($qodeFramework->qodeOptions->adminPages as $key=>$value ) {
    	...
    	$subpage_hook_suffix = add_submenu_page(
    		'qode_theme_menu',
	        '四亩地选项 - '.$value->title,                   // The value used to populate the browser's title bar when the menu page is active
									...
									<?php } else { ?>
										<form method="post" class="qode_ajax_form">
											...
											<div class="qodef-page-form">
												...
												<div class="qodef-input-change">你需要保存你的更改</div>
												<div class="qodef-changes-saved">所有更改已成功保存</div>
